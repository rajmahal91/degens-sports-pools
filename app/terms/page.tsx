...
export default function TermsPage() {
  return (
    <main className="legalPage">
      ...
      <h2>Pool rules</h2>
      <p>Each commissioner is responsible for publishing clear pool rules, deadlines, entry requirements, prize descriptions, and eligibility requirements. Picks are subject to the applicable lock time. A missed or late pick may be treated according to the rules of that pool.</p>
      <h2>Payments and prizes</h2>
      <p>The app may record payment submissions and commissioner verification. It does not itself guarantee a prize, payment, or outcome. Commissioners must comply with applicable laws, contest requirements, tax obligations, and any platform or payment-provider restrictions.</p>
      <h2>Acceptable use</h2>
      <p>You may not interfere with the service, attempt to access another user's data, manipulate picks or draw results, upload unlawful content, or use the service to violate applicable law.</p>
