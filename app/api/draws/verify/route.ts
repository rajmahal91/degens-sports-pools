...
export async function GET(req:Request){
 ...
 return NextResponse.json({drawId:d.id,verified:calculated===d.verification_hash,calculatedHash:calculated,storedHash:d.verification_hash,randomlySelected:{id:d.original_winner_snapshot_id||d.original_winner_entry_id||d.winner_entry_id,name:d.original_winner_name||d.winner_name},currentWinner:{id:d.winner_snapshot_id||d.winner_entry_id,name:d.winner_name},commissionerOverride:!!d.overridden_at,overrideReason:d.override_reason||null,overriddenAt:d.overridden_at||null,drawnAt:d.drawn_at});
}
